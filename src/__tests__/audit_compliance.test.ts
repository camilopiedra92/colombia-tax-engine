    ...
    const payer1 = createPayer([
      {
        ...
        description: 'Donación Recibida Familiar',
        grossValue: smallDonation,
        heldDurationDays: 1000, // > 2 years equivalent for GO check
      },
    ]);
    ...
    const payer2 = createPayer([
      {
        ...
        grossValue: hugeDonation,
        heldDurationDays: 1000,
      },
    ]);
