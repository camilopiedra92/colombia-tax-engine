...
describe('Tax Engine Orchestrator', () => {
  ...
  it('should calculate dividend tax with discount for residents', () => {
    ...
    expect(
      Math.abs(result.cedulaDividendos.subCedula1.discount19 - expectedDiscount),
      ...
      incomes: [
        {
          ...
          healthContribution: 20_000_000,
          pensionContribution: 20_000_000,
        },
        { id: '2', category: 'dividendos_gravados', description: 'Divs', grossValue: dividends },
        {
          id: '3',
          category: 'ganancia_ocasional',
          description: 'Herencia Tio',
          grossValue: inheritance,
        },
      ],
      assets: [{ id: 'a1', category: 'inversion', description: 'Portfolio', value: wealth }],
    };
